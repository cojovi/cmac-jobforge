...
import { Calendar as CalendarIcon, CheckCircle, Clock, FileText, AlertCircle, Plus, Info } from "lucide-react";
...
export function JobDetailsTab({ job, proposals, proposalTotal }: JobDetailsTabProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3 flex-wrap text-sm">
        ...
        {job.proposalStatus && (
          <Badge className={cn("gap-1", getStatusBadgeClasses(job.proposalStatus))}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-2">
          ...
          <Select defaultValue={job.assignee.name}>
            ...
            <SelectContent>
              <SelectItem value={job.assignee.name}>
                {job.assignee.name}
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        <div className="space-y-2">
          ...
          <Input
            defaultValue={formatCurrency(job.value)}
